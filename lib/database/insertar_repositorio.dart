...
Future<void> insertarRepositorio(BuildContext context) async {
  ...
  try {
    ...
    var productos = <Producto>[
      Producto(
          ...
          cantidadOriginalProducto: 2000.0),
      Producto(
      ...
      Producto(
          ...
          cantidadUnidadesProducto: 1,
          cantidadOriginalProducto: 155.0),
      Producto(
          nombreProducto: 'Sal',
      ...
      Producto(
          ...
          tipoUnidadProducto: 'mililitros',
          cantidadUnidadesProducto: 1,
          cantidadOriginalProducto: 900.0),
      Producto(
      ...
      Producto(
          ...
          tipoUnidadProducto: 'gramos',
          cantidadUnidadesProducto: 1,
          cantidadOriginalProducto: 100.0),
      Producto(
...
//     }
  ...
  try{
    ...
    Provider.of<RecetasProvider>(context,
            listen: false)
        .obtenerRecetas();
    Provider.of<IngredientesRecetasProvider>(
            context,
            listen: false)
        .obtenerIngredientes();
  } catch (e) {
    CustomLogger().logError('Error al actualizar la ui: $e');
  }
}
