...
//     // Verificar si las unidades de medida son iguales
//     if (producto.tipoUnidadProducto == ingrediente.tipoUnidadIngrediente) {
//       tiposCompatibles = true; // Las unidades son iguales, no es necesario convertir
//     } else if (sonTiposCompatibles(
//         producto.tipoUnidadProducto, ingrediente.tipoUnidadIngrediente)) {
//       tiposCompatibles = true;
//       // Convertir la cantidad del ingrediente a la unidad del producto
...
//       // Condición 1: Si cantidadProducto es menor o igual a la cantidad de ingrediente y cantidadUnidadesProducto es 1
//       if (nuevaCantidad <= 0 && producto.cantidadUnidadesProducto == 1) {
//         // Mostrar mensaje de que el producto está agotado
//         final mensaje = 'Falta el producto ${producto.nombreProducto} para la receta.';
//         ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(mensaje)));
//         CustomLogger().logError('Producto agotado: ${producto.nombreProducto}');
//         continue; // Saltar a la siguiente coincidencia
//       }

//       // Condición 2: Si cantidadProducto es menor o igual a la cantidad de ingrediente y cantidadUnidadesProducto > 1
//       if (nuevaCantidad <= 0 && producto.cantidadUnidadesProducto > 1) {
//         nuevaCantidad = producto.cantidadOriginalProducto + cantidadActual - cantidadIngredienteTransformada;
...
//         );
//       } else {
//         // Actualizar normalmente si la cantidad no llega a cero
//         producto = Producto(
//           idProducto: idProducto,
//           cantidadProducto: nuevaCantidad,
//           nombreProducto: producto.nombreProducto,
